    ...
    [
      ...
      ( [
        ...
        [
          ...
          (fun t ->
            Out_channel.output_substring t "\165\250\027\183\184o\228\026\018"
              86 0
            |> ignore);
          (fun t -> Out_channel.close t |> ignore);
      ...
      ( [
        ...
        [
          ...
          (fun t ->
            Out_channel.output_substring t "\208\213\203" 90 3 |> ignore);
          (fun t -> Out_channel.length t |> ignore);
      ...
      ( [
          ...
          (fun t ->
            Out_channel.output_string t "\162\212\170V\200\230\240\219"
            |> ignore);
          (fun t -> Out_channel.close_noerr t |> ignore);
        ...
        [
          ...
          (fun t -> Out_channel.close t |> ignore);
          (fun t ->
            Out_channel.output_substring t "m<\245\238B\136\238\228" 0 2
            |> ignore);
          (fun t -> Out_channel.flush t |> ignore);
          (fun t -> Out_channel.close_noerr t |> ignore);
      ...
      ( [
        ...
        [
          (fun t ->
            Out_channel.output_substring t "\241f\218\217" 0 0 |> ignore);
          (fun t ->
            Out_channel.output_substring t
      ...
      ( [
          ...
          (fun t -> Out_channel.seek t 8 |> ignore);
          (fun t ->
            Out_channel.output_substring t "ZG\022\023\012" 3 0 |> ignore);
          (fun t -> Out_channel.set_binary_mode t true |> ignore);
          (fun t -> Out_channel.pos t |> ignore);
          (fun t -> Out_channel.is_buffered t |> ignore);
          (fun t ->
      ...
      ( [
          ...
          (fun t ->
            Out_channel.output_substring t "\201\014v\146" 6 7 |> ignore);
          (fun t -> Out_channel.length t |> ignore);
          (fun t -> Out_channel.pos t |> ignore);
          (fun t -> Out_channel.flush_all () |> ignore);
          (fun t -> Out_channel.set_buffered t false |> ignore);
      ...
      ( [
          ...
          (fun t -> Out_channel.output_byte t 9 |> ignore);
          (fun t ->
            Out_channel.output_substring t "\174\017\208" 87 25 |> ignore);
      ...
      ( [
          ...
          (fun t ->
            ...
            |> ignore);
          (fun t ->
            Out_channel.output_substring t "j\026\210\025" 75 0 |> ignore);
          (fun t ->
      ...
      ( [
        ...
        [
          (fun t ->
            Out_channel.output_substring t "/\224\193\182" 1 7 |> ignore);
          (fun t -> Out_channel.is_buffered t |> ignore);
          (fun t -> Out_channel.pos t |> ignore);
          (fun t -> Out_channel.flush_all () |> ignore);
      ...
      ( [
        ...
        [
          ...
          (fun t -> Out_channel.close_noerr t |> ignore);
          (fun t ->
            Out_channel.output_substring t "/\158\194\023" 8 2 |> ignore);
          (fun t -> Out_channel.length t |> ignore);
          (fun t ->
            Out_channel.output_string t "\146\200\151\207\137t" |> ignore);
        ] );
      (* -> true *)
      ( [
          (fun t -> Out_channel.flush t |> ignore);
        ...
        [
          ...
          (fun t -> Out_channel.length t |> ignore);
          (fun t ->
            Out_channel.output_substring t "\023{\250\155%\217\148" 7 5
            |> ignore);
          (fun t -> Out_channel.seek t 2 |> ignore);
          (fun t -> Out_channel.output_byte t 0 |> ignore);
          (fun t -> Out_channel.length t |> ignore);
        ...
        [
          ...
          (fun t -> Out_channel.set_binary_mode t true |> ignore);
          (fun t ->
            Out_channel.output_string t "\026O\201\159\185\024" |> ignore);
          (fun t -> Out_channel.set_buffered t false |> ignore);
          (fun t -> Out_channel.set_buffered t false |> ignore);
          (fun t -> Out_channel.length t |> ignore);
          (fun t -> Out_channel.flush_all () |> ignore);
      ...
      ( [
        ...
        [
          ...
          (fun t ->
            Out_channel.output_string t "\233\169\127\023l\201\247\250"
            |> ignore);
        ],
        [
          (fun t -> Out_channel.seek t 3 |> ignore);
