...
(** The [bounded_array] combinator represents the [array] type with a bounded size.
    The generated arrays from [array t] have a length resulting from [QCheck.Gen.int_bound]
    and have their elements generated by the [t] combinator.
...
module ExpandSpec : functor (Spec : Spec) -> Lin_internal.ExpandedSpec
(* FIXME *)
